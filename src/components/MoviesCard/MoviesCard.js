...
import like from '../../images/movies/like.svg';
import dislike from '../../images/movies/dislike.svg';
    ...
    <>
      <article className='movies-card'>
        ...
        <div className='movies__container'>
          ...
          <img className='movies__like-button' src={like} alt='Лайк' />
      ...
      <article className='movies-card'>
        ...
        <div className='movies__container'>
          ...
          <img className='movies__like-button' src={dislike} alt='Удаление лайка' />
        </div>
        <div className='movies__duration'>1ч42м</div>
      </article>
      <article className='movies-card'>
